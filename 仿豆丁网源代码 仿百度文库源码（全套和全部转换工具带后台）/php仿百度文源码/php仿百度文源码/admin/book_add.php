...
if($dopost != 'save')
{
	...
	include DedeInclude("templets/book_add.htm");
	exit();
}
/*--------------------------------
function __save(){  }
...
else if($dopost=='save')
{
  ...
  $isremote  = (empty($isremote)? 0  : $isremote);
	...
	//added by 曹志阳，这里要根据附件ID取附件路径和附件大小 2010-08-11	
	...
	//这里将附件信息与文档关联起来 by caozhiyang
	//ClearMyAddon($arcID, $title);
	$dsql->ExecuteNoneQuery("Update `#@__uploads` set arcid='$arcID' where aid='$uploadId' ");
