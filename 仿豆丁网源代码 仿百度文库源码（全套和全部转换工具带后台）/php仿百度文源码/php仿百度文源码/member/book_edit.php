...
if(empty($dopost))
{
	...
	$tags = GetTags($aid);
	include(DEDEMEMBER."/templets/book_edit.htm");
	exit();
}
...
else if($dopost=='save')
{
	...
	/**
	$msg = "　　请选择你的后续操作：
		<a href='book_add.php?cid=$typeid'><u>发布新文章</u></a>
		&nbsp;&nbsp;
		<a href='book_edit.php?channelid=$channelid&aid=".$aid."'><u>查看更改</u></a>
		&nbsp;&nbsp;
	...
	$win->Display();
	*/
	ShowMsg("文档修改成功！返回我发布的文档列表...","content_list.php?channelid={$channelid}", "0", 3000);
}
