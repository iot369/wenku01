...
基本功能: 根据词频词典较为智能的中文分词，支持规则识别人名、地区等。（<a href="v4.php">GBK点这里</a& gt; <a href="v48.cht.php">繁体版</a>）<br />
<a href="http://www.ftphp.com" target="_blank">推荐看看，首个融合采用 scws 的 web 全文检索应用方案 FTPHP ！！</a>
<hr />
...
<?php } ?>
    ...
    <tr>
      <td width=100%>
        ...
        (<a href="http://www.hightman.cn/bbs/forumdisplay.php?fid=6" target="_blank">这次分词结果不对，点击汇报</a>)
        <br />
        <pre class=demotx style="color:#888888; border:2px inset; background-color: #ffffff;">
<?php
if ($stats == true)
{
    // stats
...
?>
        ...
        <small>
          ...
          本程序可以直接<a href="?source" target="_blank">查看源码</a> Powered by <?php echo scws_version();?>
        </small>
    </td>
  </tr>
</table>
